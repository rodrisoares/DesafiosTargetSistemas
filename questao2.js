...
function validarFib(n) {
    ...
    if (c == n) {
        console.log(`O número ${n} pertence a sequencia de Fibonacci!`);
        return true;
    } else {
        console.log(`O número${n} não pertence a sequencia de Fibonacci`);
        return false;
    }
}

//digitar o número para verificar se é fibonacci
validarFib(7);
